...
export const Ul = ({ children, ...props }) => (
  <ul {...props} className="pl-12 md:pl-16 list-disc my-12 max-w-3xl mx-auto ">
    {children}
  </ul>
)
export const Ol = ({ children, ...props }) => (
  <ul
    {...props}
    className="pl-12 md:pl-16 list-decimal my-12 max-w-3xl mx-auto "
  >
    {children}
  </ul>
)
...
export const Pre = ({ children, ...props }) => {
  return (
    <div className="bg-gray-900 rounded-md max-w-3xl  lg:p-8 p-4 xl:p-12  mx-4 md:mx-auto my-12 text-gray-200 overflow-y-scroll ">
      <pre>{children}</pre>
    </div>
  )
}
...
export const Code = ({ children, ...props }) => (
  <code
    className="bg-gray-900 text-green-400 py-1 px-2 mx-1 rounded-md font-bold "
    {...props}
  >
    {children}
  </code>
...
export const Quote = ({ children }) => (
  <div className="pl-4">
    <h4 className="text-xl md:px-8 text-justify border-solid border-l-4 border-highlight ">
      {children}
    </h4>
  </div>
)
  ...
  if (image) {
    ...
    return (
      <figure className="my-8">
        ...
        />
        {alt && (
          <figcaption className="block text-sm text-center my-2 italic">
            {alt}
          </figcaption>
        )}
      </figure>
